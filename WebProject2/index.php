...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <div class="consec">
      <a href="#contact"><input type="submit"  class="sub3" value="Get In Touch" class="btn btn-default btn-lg" /></a>
    </div>
       <style>
       .sub3
        {
...
<h2 style="color: #4E03E0; padding: 5px; font-weight: bold;">What our users say</h2>
...
<div class="container-fluid bg-blue" id="contact" >
    ...
    <div class="col-sm-7 slideanim">
      ...
      <div class="row">
        <div class="col-sm-12 form-group">
          <span style="color: #4E03E0; font-weight: bold; background-color: #ffff;"><button class="btn btn-default pull-right" type="submit" >Send</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="col-sm-4 box">
<a href="https://docs.google.com/forms/d/e/1FAIpQLSdqXWX_hsdSWaJF3htk4K1d-l4xTpymBtgxZDY7hMKvuoI4UQ/viewform" target="_blank">Feedback</a></div></div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="color:#4E03E0; font-weight: bold;">Developers</h4>
      </div>
    ...
    <div class="row">
    <div class="col-md-12">
     <img src="image/dev.png" width=100% height=100%>
     </div>
     <div class="col-md-5">
    </div></div>
    </p>
...
<script>
  ...
  $(".consec a, footer a[href='#myPage']").on('click', function(event) {
